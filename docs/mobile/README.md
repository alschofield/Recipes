...
Planning and contract references for native mobile rollout.

- `native-platform-decision-v1.md` - pure native stack decision and rationale.
- `product-scope-v1.md` - jobs-to-be-done, metrics, offline and notification scope.
- `ux-navigation-spec-v1.md` - IA, touch rules, and state behavior.
- `design-system-parity-v1.md` - token/component parity and accessibility baseline.
- `api-usage-policy-v1.md` - cache/retry/auth/offline behavior for mobile clients.
- `architecture-data-policy-v1.md` - feature flags and analytics taxonomy.
...
- `voice-privacy-policy-v1.md` - consent, retention, and disclosure policy for mobile voice input.
- `voice-stt-validation-matrix-v1.md` - Android/iOS scenario matrix for STT hardening and signoff.
